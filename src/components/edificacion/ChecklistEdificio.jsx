...
function ChecklistEdificio({ onChange, datosPrevios, quincenaActiva }) {
  // datosPrevios ahora solo cargará los items de la quincena seleccionada
  ...
  return (
    <div ref={topRef} style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      {/* Etiqueta que le recuerda qué quincena está evaluando */}
      <div style={{ textAlign: 'center', marginBottom: '15px', fontWeight: 'bold', color: '#FF9800' }}>
        Actualmente evaluando: {quincenaActiva === "quincena1" ? "1ra Quincena" : "2da Quincena"}
      </div>
